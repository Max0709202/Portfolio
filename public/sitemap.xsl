...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        <title>XML Sitemap - max-dev.xyz</title>
        <meta charset="UTF-8"/>
      ...
      <body>
        <div class="container">
          <h1>XML Sitemap</h1>
          <p class="subtitle">This sitemap contains <strong><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/></strong> URLs for max-dev.xyz</p>
